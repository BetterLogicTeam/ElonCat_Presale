          ...
          <div className="col-md-12">
            ...
            <div className="market-media">
              <div className="row justify-content-between align-items-center">
                <div className="col-lg-5 coin_main_list"  data-aos="fade-right" >
                ...
                <div className="col-lg-5 mt-3 mt-md-0"  data-aos="fade-left">
                  <div className="nft-img">
                    <img src={nft_img} alt="" className="img-fluid up_down w-100"  />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-lg-6"  data-aos="fade-right">
                  <div className="ai-img">
                    <img src={ai_img} alt="" className="img-fluid  up_down position-relative z-2" />
                  </div>
                </div>
                ...
                <div className="col-lg-6">
                  <div className="title">
                    ...
                    <div className="row align-items-center">
                      ...
                      <img src="images/binance.png" style={{width:"200px"}}  className=""  alt="" />

                      </div>
                      <div className="col-md-4 my-2 col-6">
                      <img src="images/polygon.png"  className="logo_list"   alt="" />

                      </div>
                      <div className="col-md-4 my-2 col-6">
                      <img src="images/avalanche.png"  className="logo_list"  alt="" />

                      </div>
                      <div className="col-md-4 my-2 col-6">
                      <img src="images/cronos.svg"  className="logo_list" alt="" />

                      </div>
                      <div className="col-md-4 my-2 col-6">
                      <img src="images/klaytn.png"  className="logo_list" alt="" />
